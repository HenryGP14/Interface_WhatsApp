 ...
 * Use the {@link tabChat#newInstance} factory method to
 * create an instance of this fragment.
 */
public class tabChat extends Fragment implements Asynchtask {
     ...
     * @return A new instance of fragment tabChat.
     */
    // TODO: Rename and change types and number of parameters
    public static tabChat newInstance(String param1, String param2) {
        tabChat fragment = new tabChat();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_tab_chat, container, false);
        ...
        WebService webService = new WebService(URL, datos,getContext(), tabChat.this);
    ...
    public void processFinish(String result) throws JSONException {
        ...
        try {
            ...
            UserAdapter adapatorUsuario = new UserAdapter(getContext(), usuarios);
