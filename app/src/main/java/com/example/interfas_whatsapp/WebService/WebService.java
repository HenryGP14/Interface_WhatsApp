package com.example.interfas_whatsapp.WebService;
...
import com.example.interfas_whatsapp.WebService.HttpRequest.HttpRequestException;
...
public class WebService extends AsyncTask<String, Long, String> {
    ...
    public WebService(String URL, Map<String, String> datos, tabChat tabChat, tabChat callback) {
